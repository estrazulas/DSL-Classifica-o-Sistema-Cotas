...
Por fim, esses componentes permitiram a construção da estrutura necessária para modelagem das regras do sistema de cotas por usuários não desenvolvedores. Em continuidade ao presente estudo, a Subseção \ref{apicotas} detalha a \gls{API} construída com o propósito validar os objetivos que concernem à geração do código fonte de classificação e aprovação de candidatos.
