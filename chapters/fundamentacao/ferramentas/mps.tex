...
\begin{itemize}
    \item A composição e mistura de sintaxes diferentes em uma mesma linguagem;
    \item A modularização e extensão de linguagens.
\end{itemize}
...
Do ponto de vista do autor da presente pesquisa, o \gls{MPS} se mostra uma ferramenta moderna e madura, sua base de exemplos possui mais de 37 projetos que podem servir como base para facilitar o aprendizado de desenvolvimento de linguagens. É uma ferramenta gratuita de com vasta documentação, e por se tratar de uma ferramenta projecional não há a necessidade de manter uma gramática formal ou de desenvolvimento de \textit{parsers}.

Com foco nessa ferramenta e nos conceitos sobre linguagens específicas de domínio apresentados, no Capítulo \ref{chap:proposta} será apresentada a linguagem proposta para ser desenvolvida nessa pesquisa, assim como algumas contribuições que poderão contribuir na geração de código fonte para classificação de candidatos ao sistema de cotas.