...
Essa Seção tem por objetivo detalhar os fatores considerados para escolha da ferramenta \gls{MPS}, como meio de implementação da linguagem de domínio desenvolvida na presente pesquisa.
