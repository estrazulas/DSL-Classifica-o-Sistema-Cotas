...
Ademais, as ferramentas Xtext e Spoofax dependem de definição de uma gramática formal, enquanto o MPS permite que as definições da linguagem sejam associadas diretamente ao modelo. Segundo \citeonline{volter2011language}, isso traz alguns benefícios durante o desenvolvimento de linguagens: 
\begin{enumerate}
...
%O detalhamento completo de implementação da \gls{API} será descrita no Capítulo \ref{chap:dslcotas} e a análise das divergências encontradas será apresentada no Capítulo \ref{chap:analise}.
