...
\begin{enumerate}
    ...
    \item[f)] Ferramentas produtivas: ao contrário de bibliotecas, \textit{frameworks} e \gls{DSL} internas, as \gls{DSL} externas podem ser fornecidas com uma \gls{IDE} preparada o seu idioma, o que pode resultar em uma experiência de usuário muito aprimorada;
