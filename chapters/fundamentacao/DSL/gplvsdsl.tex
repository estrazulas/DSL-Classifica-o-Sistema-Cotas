...
Segundo \citeonline{dslengineering}, o propósito das \gls{DSL}s é de atender a um domínio específico, são construídas para resolver uma classe específica de problemas. De outro lado, as \gls{GPL}s são voltadas aos desenvolvedores para resolver qualquer tipo de problema computável:
