...
\label{contextualizacao}
 ...
 Para \citeonline{ghosh2011dsl}, falhas na comunicação entre desenvolvedores e especialistas de domínio, são os principais motivos de falha no desenvolvimento e evolução de projetos de software. Usuários especialistas entendem a terminologia do domínio e falam em um vocabulário que pode ser bastante estranho para as equipes de desenvolvedores. Nesse sentido, é preciso identificar meios para redução da lacuna semântica entre usuários de negócio e desenvolvedores, de modo que os usuários possam estar envolvidos na verificação de regras de negócio ao longo do ciclo de vida do projeto.
